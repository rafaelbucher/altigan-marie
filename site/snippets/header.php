  ...
  <header id="top" class="site-header" role="banner">
    <div class="container" style="padding:1rem;max-width:1200px;margin:0 auto;">
      <div class="brand" style="display:flex;align-items:center;gap:.75rem;">
        <a href="<?= $site->url() ?>" class="brand-link" aria-label="Accueil Atilgan Marie">
          <?= html($site->FirstName()->or('Marie')) ?>
          <span><?= html($site->LastName()->or('Atilgan')) ?></span>
        </a>
      </div>
    ...
    <div class="modal__box" role="document" tabindex="-1">
      ...
      <div class="modal__content">
        ...
        <p style="margin:0;line-height:1.6;">
            ...
            <br>Mail : <a href="mailto:contact@Atilgan-marie.art">contact@Atilgan-marie.art</a>
        </p>
        <p style="margin:0;">
  ...
  <div id="tsunami-modal" class="modal" aria-hidden="true" role="dialog" aria-modal="true" aria-labelledby="tsunami-modal-title">
    <div class="modal__box" role="document" tabindex="-1">
      ...
      <div class="modal__content">
          ...
          <p>
              Je t’appellerai Tsunami<br>
              Toi qui as détruis ma vie<br>
              Un jour sans m’en rendre compte<br>
              Je me suis réveillée avec un décompte<br>
              Ce putain de Tsunami m’a envahi<br>
              jusqu’à ne plus pouvoir parler<br>
              jusqu’à ne plus pouvoir bouger<br>
              Je ne m’en suis pas remis<br>
              Quoi dire, quoi faire, je me sens démuni<br>
              Ce putain de Tsunami m’a envahi<br><br>

              Comment l’annoncer à mes proches, à mes enfants<br>
              Souffrance, combat, moi même je n’y croit pas vraiment<br>
              Comment vivre avec cette annonce térrifiante<br>
              Le temps qui me reste me hante<br><br>

              Cette maladie s’étend comme un raz de marée<br>
              Malgré tous mes efforts obstinés<br>
              On me dit que le moral est pour beaucoup<br>
              Et pourtant, et pourtant je n’ai plus de goût<br><br>

              Je ris, je pleure, je prie en espérant un miracle<br>
              Je sais pertinemment que c’est un simulacre<br>
              Malgré ma rage de vivre, ce Tsunami me rattrapera<br>
              Et cette souffrance, ce combat continuera et s’éternisera<br>
              Dégage, laisse moi tranquille<br>
              Putain de Tsunami<br>
              Pour toi c’est fini<br>
        </p>
      </div>
    </div>
  </div>
